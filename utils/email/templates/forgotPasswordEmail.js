/**
 * @typedef {Object} ForgotPwdEmailTemplateDataType
 ...
 * @param {ForgotPwdEmailTemplateDataType} data - The user object.
 */
      ...
      <tbody>
        <tr style="width:100%">
          <td>
            ...
            <h1 class="" style="color:rgb(0,0,0);font-size:24px;font-weight:400;text-align:center;padding:0px;margin-top:30px;margin-bottom:30px;margin-left:0px;margin-right:0px">Reset your password !</h1>
            <p style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0)">Hello ${data.firstName},</p>
            <p style="font-size:14px;line-height:24px;margin:16px 0;color:rgb(0,0,0)">Forgot your password? That's okay!</p>
